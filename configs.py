...
class BaseConfig:
    ...
    parser.add_argument("--device", default="cuda", type=str, help="Device for computation")
    ...
    parser.add_argument("--ckpt_per_epoch", default=1, type=int, help="Save checkpoint every ? epochs")
    ...
    parser.add_argument("--dropout_date", default=.1, type=float, help="Keyword argument `p` of Dropout")
